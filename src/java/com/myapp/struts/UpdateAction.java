...
public class UpdateAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String state = updateForm.getState();
        String zip = updateForm.getZip();
        String creditcard = updateForm.getCardNumber();
        String expdate = updateForm.getExpDate();
        String code = updateForm.getSecNum();
        String cardname = updateForm.getNameOnCard();
